...
const COMPANY = "KDT Thanh Hà - Mường Thanh Cienco 5";
const ADDRESS =
  "Khu B1.4, Liền kề 09 VT 23, Khu đô thị Thanh Hà Mường Thanh Cienco 5";
...
website.innerHTML = `Website: <a href="#">www.kdtthanhha.com</a>`;
addressFooter.innerHTML = `VPGD: ${ADDRESS}`;
